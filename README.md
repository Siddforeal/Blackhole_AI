...
v1.84.1 removes the README demo visual and returns the landing page to a text-only presentation.

The demo command, JSON and Markdown examples, explicit version fields, and local-only safety boundary remain unchanged.
